...
router.post('/chat', apiLimiter, validateBody(['message', 'history', 'systemInstruction']), async (req, res) => {
    try {
...
router.post('/concept-map', apiLimiter, validateBody(['courseKnowledge', 'courseName']), async (req, res) => {
    try {
