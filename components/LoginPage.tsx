      ...
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="text-4xl font-black text-white font-mono tracking-tighter">
            SEMESTER<span className="text-indigo-500">FLOW</span>
          </h1>
          <p className="text-gray-500 font-mono text-sm mt-2">
            Advanced Academic Trajectory System
          </p>
        </div>
        ...
        <div className="retro-card p-8 bg-gray-900 border-indigo-500 shadow-[8px_8px_0px_0px_#6366f1]">
          ...
          <div className="mt-8 text-[10px] font-mono text-gray-600 text-center leading-relaxed">
            By initiating session, you agree to the storage of academic data within the Supabase
            Database.
          </div>
        </div>
        ...
        <div className="mt-8 flex justify-center gap-6 opacity-50">
          ...
          <div className="font-mono text-xs text-gray-500 uppercase pt-1">
